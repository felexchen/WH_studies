...
#sampleFiles = glob.glob('/hadoop/cms/store/user/fechen/nanoAOD/TTJets_SingleLeptFromT_TuneCP2_13TeV-madgraphMLM-pythia8__RunIIFall17NanoAODv6-PUFall17Fast_Nano25Oct2019_lhe_102X_mc2017_realistic_v7-v1/*.root')
sampleFiles = glob.glob('/hadoop/cms/store/user/fechen/nanoAOD/TTJets_SingleLeptFromT_TuneCP2_13TeV-madgraphMLM-pythia8__RunIIFall17NanoAODv6-PUFall17Fast_Nano25Oct2019_lhe_102X_mc2017_realistic_v7-v1/1F48F006-AA2A-5F4B-9E73-6B20D23D541B.root')
#outputFile = '/hadoop/cms/store/user/dspitzba/WH_studies/ttdilep_JEC.root'
outputFile = '/hadoop/cms/store/user/fechen/WH_studies/ttsinglelep_JEC.root'
