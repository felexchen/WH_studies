...
h_deltaR_full = fullSim.get1DHistoFromDraw('sqrt((acos(cos(Jet_phi)) - acos(cos(GenJet_phi[Jet_genJetIdx])))**2 + (Jet_eta - GenJet_eta[Jet_genJetIdx])**2)', [40,0,1], weightString='(1)', selectionString = 'Jet_pt>200 && Jet_genJetIdx>=0', addOverFlowBin='both')
h_deltaR_fast = fastSim.get1DHistoFromDraw('sqrt((acos(cos(Jet_phi)) - acos(cos(GenJet_phi[Jet_genJetIdx])))**2 + (Jet_eta - GenJet_eta[Jet_genJetIdx])**2)', [40,0,1], weightString='(1)', selectionString = 'Jet_pt>200 && Jet_genJetIdx>=0', addOverFlowBin='both')
h_deltaPhi_full = fullSim.get1DHistoFromDraw('acos(cos(Jet_phi)) - acos(cos(GenJet_phi[Jet_genJetIdx]))', [100,-0.4,0.4], weightString='(1)', selectionString = 'Jet_pt>200 && Jet_genJetIdx>=0', addOverFlowBin='both')
h_deltaPhi_fast = fastSim.get1DHistoFromDraw('acos(cos(Jet_phi)) - acos(cos(GenJet_phi[Jet_genJetIdx]))', [100,-0.4,0.4], weightString='(1)', selectionString = 'Jet_pt>200 && Jet_genJetIdx>=0', addOverFlowBin='both')
h_deltaEta_full = fullSim.get1DHistoFromDraw('Jet_eta - GenJet_eta[Jet_genJetIdx]', [100,-0.4,0.4], weightString='(1)', selectionString = 'Jet_pt>200 && Jet_genJetIdx>=0', addOverFlowBin='both')
h_deltaEta_fast = fastSim.get1DHistoFromDraw('Jet_eta - GenJet_eta[Jet_genJetIdx]', [100,-0.4,0.4], weightString='(1)', selectionString = 'Jet_pt>200 && Jet_genJetIdx>=0', addOverFlowBin='both')
...
## styles
h_deltaR_full.legendText = 'FullSim'
h_deltaR_full.style = styles.lineStyle(ROOT.kBlue+1, width=2, errors=True)
h_deltaR_fast.legendText = 'FastSim'
h_deltaR_fast.style = styles.lineStyle(ROOT.kGreen+1, width=2, errors=True)
h_deltaPhi_full.legendText = 'FullSim'
h_deltaPhi_full.style = styles.lineStyle(ROOT.kBlue+1, width=2, errors=True)
h_deltaPhi_fast.legendText = 'FastSim'
h_deltaPhi_fast.style = styles.lineStyle(ROOT.kGreen+1, width=2, errors=True)
h_deltaEta_full.legendText = 'FullSim'
h_deltaEta_full.style = styles.lineStyle(ROOT.kBlue+1, width=2, errors=True)
h_deltaEta_fast.legendText = 'FastSim'
h_deltaEta_fast.style = styles.lineStyle(ROOT.kGreen+1, width=2, errors=True)
"""
...
plotting.draw(
    Plot.fromHisto(name = "deltaR", histos = [ [h_deltaR_full], [h_deltaR_fast] ], texX = "delta R", texY = "a.u."),
    plot_directory = plot_path,
    logX = False, logY = True, sorting = False,
    scaling = {1:0},
    ratio = {'histos': [(1,0)], 'texY': 'x / FullSim'},
)
plotting.draw(
    Plot.fromHisto(name = "deltaPhi", histos = [ [h_deltaPhi_full], [h_deltaPhi_fast] ], texX = "phi", texY = "a.u."),
    plot_directory = plot_path,
    logX = False, logY = True, sorting = False,
    scaling = {1:0},
    ratio = {'histos': [(1,0)], 'texY': 'x / FullSim'},
...
plotting.draw(
    Plot.fromHisto(name = "deltaEta", histos = [ [h_deltaEta_full], [h_deltaEta_fast] ], texX = "eta", texY = "a.u."),
    plot_directory = plot_path,
    logX = False, logY = True, sorting = False,
    scaling = {1:0},
    ratio = {'histos': [(1,0)], 'texY': 'x / FullSim'},
