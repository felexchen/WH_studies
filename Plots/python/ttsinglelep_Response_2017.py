...
h_profile_response_b_full = fullSim.get1DHistoFromDraw(variableString="Jet_pt/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[(i-20)/5.0 for i in range(41)], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&abs(Jet_partonFlavour)==5&&Jet_genJetIdx>-1&&PV_ndof>4 && sqrt(PV_x*PV_x+PV_y*PV_y)<=2 && abs(PV_z)<=24')
#h_profile_response_b_fast = fastSim.get1DHistoFromDraw(variableString="Jet_pt_nom/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[30,50,70,100,130,170, 200, 250, 300, 400, 600, 1000], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&Jet_jetId&&abs(Jet_partonFlavour)==5&&Jet_genJetIdx>-1')
h_profile_response_b_fast = fastSim.get1DHistoFromDraw(variableString="Jet_pt_nom/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[(i-20)/5.0 for i in range(41)], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&abs(Jet_partonFlavour)==5&&Jet_genJetIdx>-1&&PV_ndof>4 && sqrt(PV_x*PV_x+PV_y*PV_y)<=2 && abs(PV_z)<=24')

#h_profile_response_ISR_full = fullSim.get1DHistoFromDraw(variableString="Jet_pt/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[30,50,70,100,130, 170, 200, 250, 300, 400, 600, 1000], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&Jet_jetId&&!(abs(Jet_partonFlavour)==5)&&Jet_btagDeepB<0.4941&&Jet_genJetIdx>-1')
h_profile_response_ISR_full = fullSim.get1DHistoFromDraw(variableString="Jet_pt/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[(i-20)/5.0 for i in range(41)], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&!(abs(Jet_partonFlavour)==5)&&Jet_genJetIdx>-1&&PV_ndof>4 && sqrt(PV_x*PV_x+PV_y*PV_y)<=2 && abs(PV_z)<=24')
#h_profile_response_ISR_fast = fastSim.get1DHistoFromDraw(variableString="Jet_pt_nom/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[30,50,70,100,130,170, 200, 250, 300, 400, 600, 1000], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&Jet_jetId&&!(abs(Jet_partonFlavour)==5)&&Jet_btagDeepB<0.4941&&Jet_genJetIdx>-1')
h_profile_response_ISR_fast = fastSim.get1DHistoFromDraw(variableString="Jet_pt_nom/GenJet_pt[Jet_genJetIdx]:Jet_eta", binning=[(i-20)/5.0 for i in range(41)], binningIsExplicit=True, isProfile=True, selectionString='Jet_pt>400&&!(abs(Jet_partonFlavour)==5)&&Jet_genJetIdx>-1&&PV_ndof>4 && sqrt(PV_x*PV_x+PV_y*PV_y)<=2 && abs(PV_z)<=24')
#binning=[(i+1)*30 for i in range(40)]
#binning=[(i-20)/5.0 for i in range(41)]

#Jet_pt_nom/GenJet_pt[Jet_genJetIdx]:Jet_eta_nom
## styles
