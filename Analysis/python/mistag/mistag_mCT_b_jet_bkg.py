#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# This script:
# 1. Separates by high and low mCT
...
def getYields(nextCount, argv):
 ...
 #%%%%%%%%%%
    ...
    for i, fileName in enumerate(argv):
        ...
        if (i == 1):
            continue # hist title
        if (("mctg150" in argv[2]) and (dataCount == nextCount)): 
...
for i in range(nPlots):
    if (("mctg150" in sys.argv[2]) and (dataIndex == i)):
        continue # signal cut does not have data
...
for i in range(nPlots):
    if (("mctg150" in sys.argv[2]) and (dataIndex == i)):
        continue # signal cut does not have data
    if 0 == totalYieldInclusive[i]: # misleading
        mistagInclusive[i] = 0
        continue
